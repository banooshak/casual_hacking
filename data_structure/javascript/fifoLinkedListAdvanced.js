...
function test() {
	...
	console.log("Does %s exist in the linked list? %s", 12, ll.doesExist(12));
	console.log("Does %s exist in the linked list? %s", 2, ll.doesExist(2));

	ll.removeNode(0);
	console.log("\nDoes %s exist in the linked list? %s", 0, ll.doesExist(0));
	ll.removeNode(3);
	console.log("\nDoes %s exist in the linked list? %s", 3, ll.doesExist(3));
	ll.removeNode(4);
	console.log("\nDoes %s exist in the linked list? %s", 4, ll.doesExist(4));
